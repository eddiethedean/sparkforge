...
# Create DataFrame with complex schema (matching LogWriter pattern)
complex_schema = StructType([
    ...
    # ... many more fields (29 total in our case)
])

current_time = datetime.now()
data = [
    ("initial_run_1", "initial", current_time, "step_1", 100),
    ("initial_run_1", "initial", current_time, "step_2", 200),
    ("other_run", "initial", current_time, "step_3", 300),
]
...
- File: `test_logwriter_schema_filter.py`
- Can be run directly: `python test_logwriter_schema_filter.py`

The script demonstrates:
- Table has 2 rows ✅
- run_id values are correct: `['initial_run_1', 'initial_run_1']` ✅
...
**Severity:** High (workarounds don't exist - filtering is essential functionality)
