...
def main():
    ...
    spark = SparkSession.builder \
        .appName("SparkForgeNoDatetimeExample") \
        .master("local[*]") \
    ...
    try:
        ...
        print(f"   Silver write mode: overwrite (forced by Bronze without incremental column)")
        
        print(f"\n🎉 Pipeline completed successfully!")
        print(f"   Key insight: Bronze tables without datetime columns force")
        print(f"   Silver tables to use overwrite mode for full refresh.")
