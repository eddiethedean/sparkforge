...
def create_sample_data(spark):
    ...
    for i in range(1000):
        orders_data.append({
            ...
            "shipping_region": random.choice(["North", "South", "East", "West", "Central"])
        })
    ...
    try:
        ...
        def enrich_orders(spark, bronze_df, prior_silvers):
            return (bronze_df
                ...
                .withColumn("discount_amount", F.col("total_amount") * F.col("discount"))
                .withColumn("final_amount", F.col("total_amount") - F.col("discount_amount"))
        ...
        def customer_analytics(spark, silvers):
            ...
            return (customer_profiles
                .groupBy("customer_tier", "preferred_region")
                .agg(
                ...
                .withColumn("revenue_share", F.col("total_revenue") / F.sum("total_revenue").over())
            )
