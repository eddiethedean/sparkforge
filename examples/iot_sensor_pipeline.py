...
def main():
    ...
    try:
        ...
        def process_sensor_data(spark, bronze_df, prior_silvers):
            return (bronze_df
                .withColumn("reading_date", F.date_trunc("day", "timestamp"))
        ...
        def sensor_health_monitoring(spark, bronze_df, prior_silvers):
            ...
            return (processed_readings
                ...
                .withColumn("is_offline", 
                    F.current_timestamp() - F.col("last_reading") > F.expr("INTERVAL 1 HOUR")
                )
            )
        ...
        if result.success:
            ...
            print("\nData Quality Summary:")
            spark.table("iot_analytics.processed_readings") \
