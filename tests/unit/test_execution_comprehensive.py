...
class TestExecutionEngineInitialization:
    ...
    def test_execution_engine_with_custom_logger(self, spark_session):
        ...
        engine = ExecutionEngine(spark=spark_session, config=config, logger=custom_logger)
...
class TestExecuteStep:
    ...
    def test_execute_bronze_step_missing_context(self, spark_session):
        ...
        with pytest.raises(ExecutionError, match="Bronze step 'test_bronze' requires data"):
...
class TestExecutePipeline:
    ...
    def test_execute_pipeline_invalid_context_type(self, spark_session):
        ...
        with pytest.raises(ExecutionError, match="Pipeline execution failed: context must be a dictionary"):
