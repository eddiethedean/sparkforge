...
class TestPipelineBuilderInitialization:
    ...
    def test_pipeline_builder_initialization_with_quality_rates(self, mock_spark_session):
...
class TestBronzeRules:
    ...
    @patch('sparkforge.validation.data_validation._convert_rules_to_expressions')
    def test_with_bronze_rules_with_incremental_col(self, mock_convert_rules, mock_spark_session):
    ...
    @patch('sparkforge.validation.data_validation._convert_rules_to_expressions')
    def test_with_bronze_rules_with_schema(self, mock_convert_rules, mock_spark_session):
    ...
    @patch('sparkforge.validation.data_validation._convert_rules_to_expressions')
    def test_with_bronze_rules_duplicate_name(self, mock_convert_rules, mock_spark_session):
...
class TestSilverRules:
    ...
    @patch('sparkforge.validation.data_validation._convert_rules_to_expressions')
    def test_with_silver_rules_with_watermark(self, mock_convert_rules, mock_spark_session):
    ...
    @patch('sparkforge.validation.data_validation._convert_rules_to_expressions')
    def test_with_silver_rules_duplicate_name(self, mock_convert_rules, mock_spark_session):
...
class TestSilverTransform:
    ...
    @patch('sparkforge.validation.data_validation._convert_rules_to_expressions')
    def test_add_silver_transform_auto_inference(self, mock_convert_rules, mock_spark_session):
    ...
    @patch('sparkforge.validation.data_validation._convert_rules_to_expressions')
    def test_add_silver_transform_invalid_source(self, mock_convert_rules, mock_spark_session):
...
class TestGoldTransform:
    ...
    @patch('sparkforge.validation.data_validation._convert_rules_to_expressions')
    def test_add_gold_transform_auto_inference(self, mock_convert_rules, mock_spark_session):
    ...
    @patch('sparkforge.validation.data_validation._convert_rules_to_expressions')
    def test_add_gold_transform_invalid_sources(self, mock_convert_rules, mock_spark_session):
...
class TestHelperMethods:
    ...
    def test_validate_schema_existing(self, mock_spark_session):
        ...
        mock_catalog.listDatabases.return_value = [
            MagicMock(name="test_schema"),
            MagicMock(name="other_schema")
        ]
        mock_spark_session.catalog = mock_catalog
    ...
    def test_create_schema_if_not_exists(self, mock_spark_session):
        ...
        # Mock the sql method
        mock_spark_session.sql = MagicMock(return_value=None)
    ...
    def test_create_schema_if_not_exists_failure(self, mock_spark_session):
        ...
        mock_spark_session.sql = MagicMock(side_effect=Exception("Permission denied"))
...
class TestIntegration:
    ...
    def test_complete_pipeline_workflow(self, mock_convert_rules, mock_spark_session):
        ...
        mock_convert_rules.return_value = {"user_id": ["not_null"], "timestamp": ["not_null"]}
    ...
    @patch('sparkforge.validation.data_validation._convert_rules_to_expressions')
    def test_pipeline_with_custom_validator(self, mock_convert_rules, mock_spark_session):
    ...
    @patch('sparkforge.validation.data_validation._convert_rules_to_expressions')
    def test_pipeline_with_multiple_schemas(self, mock_convert_rules, mock_spark_session):
