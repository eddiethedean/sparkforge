...
class TestEdgeCases:
    ...
    def test_boundary_values(self, mock_spark_session):
        ...
        large_data = [
            {"id": 2147483647, "value": 1.7976931348623157e+308},  # Max int and double
    ...
    def test_session_edge_cases(self, mock_spark_session):
        ...
        assert not mock_spark_session.catalog.tableExists("test_schema", "nonexistent_table")
