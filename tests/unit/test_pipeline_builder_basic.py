...
class TestPipelineBuilderInitialization:
    ...
    def test_pipeline_builder_initialization_with_quality_rates(self, spark):
...
class TestStepManagement:
    ...
    def test_bronze_steps_storage(self, spark):
    ...
    def test_silver_steps_storage(self, spark):
    ...
    def test_gold_steps_storage(self, spark):
    ...
    def test_pipeline_configuration(self, spark):
    ...
    def test_pipeline_logger(self, spark):
        """Test pipeline logger properties."""
        builder = PipelineBuilder(
            spark=spark, schema="test_schema", verbose=True
        )
    ...
    def test_pipeline_id_generation(self, spark):
    ...
    def test_schema_property(self, spark):
        """Test schema property access."""
        builder = PipelineBuilder(spark=spark, schema="my_test_schema")

        assert builder.schema == "my_test_schema"

    def test_validators_property(self, spark):
