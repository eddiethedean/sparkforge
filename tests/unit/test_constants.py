...
class TestConstantsIntegration:
    ...
    def test_positive_values(self):
        ...
        positive_constants = [
            ...
            DEFAULT_MAX_MEMORY_MB, DEFAULT_CACHE_MEMORY_MB,
            DEFAULT_MAX_FILE_SIZE_MB, DEFAULT_BACKUP_COUNT,
            DEFAULT_CACHE_PARTITIONS, DEFAULT_SHUFFLE_PARTITIONS,
            DEFAULT_BRONZE_THRESHOLD, DEFAULT_SILVER_THRESHOLD, DEFAULT_GOLD_THRESHOLD,
            DEFAULT_TIMEOUT_SECONDS, DEFAULT_RETRY_TIMEOUT_SECONDS,
            MAX_ERROR_MESSAGE_LENGTH, MAX_STACK_TRACE_LINES,
            DEFAULT_METRICS_INTERVAL_SECONDS, DEFAULT_ALERT_THRESHOLD_PERCENT,
        ]
    ...
    def test_string_constants_not_empty(self):
        ...
        for constant in string_constants:
            assert len(constant) > 0, f"String constant '{constant}' should not be empty"
