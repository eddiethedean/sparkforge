...
from sparkforge.writer.models import WriterConfig, LogRow, WriterMetrics, LogLevel, WriteMode
...
def create_execution_result(execution_id: str = "test-execution-123", mode: ExecutionMode = ExecutionMode.INITIAL) -> ExecutionResult:
...
class TestWriterComprehensive:
    ...
    def test_time_write_operation_function(self, mock_spark_session):
        ...
        rows_written, duration, start_time, end_time = time_write_operation(test_operation)
    ...
    def test_log_writer_with_custom_logger(self, mock_spark_session):
        ...
        writer = LogWriter(spark=mock_spark_session, config=config, logger=custom_logger)
    ...
    def test_write_execution_result_with_metadata(self, mock_spark_session):
        ...
        execution_result = create_execution_result("test-execution-123", ExecutionMode.INITIAL)
    ...
    def test_writer_with_different_log_levels(self, mock_spark_session):
        ...
        for log_level in log_levels:
            ...
            execution_result = create_execution_result(f"test-execution-{log_level.value}", ExecutionMode.INITIAL)
    ...
    def test_writer_with_compression_settings(self, mock_spark_session):
        ...
        for compression in compression_options:
            ...
            execution_result = create_execution_result(f"test-execution-{compression}", ExecutionMode.INITIAL)
