...
import pytest
from sparkforge.execution import ExecutionEngine, ExecutionMode, StepStatus, StepType, StepExecutionResult, ExecutionResult
from sparkforge.models import StepResult, PipelineConfig, ValidationThresholds, ParallelConfig
...
class TestExecutionEngineSimple:
    ...
    def test_execution_engine_with_sample_data(self, spark_session, sample_dataframe):
        ...
        assert len(sample_dataframe.columns) > 0  # Fixed: columns is a property, not a method
