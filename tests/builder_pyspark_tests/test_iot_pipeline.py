...
class TestIotPipeline:
    ...
    def test_complete_iot_sensor_pipeline_execution(self, spark_session, data_generator, test_assertions):
        """Test complete IoT pipeline: sensor readings → anomaly detection → device health analytics."""
        
        # Create realistic sensor data
        sensor_data = data_generator.create_iot_sensor_data(spark_session, num_readings=100)
    ...
    def test_incremental_sensor_processing(self, spark_session, data_generator, test_assertions):
        """Test incremental processing of new sensor readings."""
        
        # Create initial sensor data
        initial_data = data_generator.create_iot_sensor_data(spark_session, num_readings=50)
    ...
    def test_anomaly_detection_pipeline(self, spark_session, data_generator, test_assertions):
        """Test anomaly detection in sensor data."""
        
        # Create sensor data with some anomalies
        normal_data = data_generator.create_iot_sensor_data(spark_session, num_readings=80)
    ...
    def test_performance_monitoring(self, spark_session, data_generator, log_writer_config, test_assertions):
        """Test performance monitoring and logging for IoT pipeline."""
        
        # Create large sensor dataset
        sensor_data = data_generator.create_iot_sensor_data(spark_session, num_readings=200)
