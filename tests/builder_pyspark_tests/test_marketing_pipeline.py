    ...
    def test_complete_marketing_pipeline_execution(
        ...
        def processed_impressions_transform(spark, df, silvers):
            ...
            return (
                df.withColumn(
                    ...
                    F.to_timestamp(F.col("impression_date"), "yyyy-MM-dd'T'HH:mm:ss[.SSSSSS]"),
                )
                .withColumn(
                    "hour_of_day",
        ...
        def processed_clicks_transform(spark, df, silvers):
            ...
            return (
                df.withColumn(
                    "click_date_parsed",
                    F.to_timestamp(F.col("click_date"), "yyyy-MM-dd'T'HH:mm:ss[.SSSSSS]"),
                )
                .withColumn(
        ...
        def processed_conversions_transform(spark, df, silvers):
            ...
            return (
                df.withColumn(
                    ...
                    F.to_timestamp(F.col("conversion_date"), "yyyy-MM-dd'T'HH:mm:ss[.SSSSSS]"),
                )
                .withColumn(
                    "is_purchase",
