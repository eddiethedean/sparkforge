...
class TestCompletePipeline:
    ...
    def test_bronze_to_silver_to_gold_pipeline(self, mock_spark_session, sample_dataframe):
        ...
        mock_spark_session.storage.create_table("bronze", "raw_events", sample_dataframe.schema.fields)
        ...
        mock_spark_session.storage.create_table("silver", "processed_events", sample_dataframe.schema.fields)
        
        # Simulate Silver layer processing (copy data for now)
        mock_spark_session.storage.insert_data("silver", "processed_events", sample_data)
        
        # Verify Silver layer data
        silver_data = mock_spark_session.storage.query_table("silver", "processed_events")
        assert len(silver_data) > 0
        assert mock_spark_session.storage.table_exists("silver", "processed_events")
        
        # Create Gold layer table
        mock_spark_session.storage.create_table("gold", "aggregated_metrics", sample_dataframe.schema.fields)
        
        # Simulate Gold layer processing (copy data for now)
        mock_spark_session.storage.insert_data("gold", "aggregated_metrics", sample_data)
    ...
    def test_pipeline_with_data_validation(self, mock_spark_session, sample_dataframe):
        ...
        # Create tables
        mock_spark_session.storage.create_table("bronze", "raw_data", sample_dataframe.schema.fields)
        mock_spark_session.storage.create_table("silver", "processed_data", sample_dataframe.schema.fields)
        mock_spark_session.storage.create_table("gold", "aggregated_data", sample_dataframe.schema.fields)
    ...
    def test_pipeline_with_logging_and_monitoring(self, mock_spark_session, sample_dataframe):
    ...
    def test_pipeline_with_different_data_sizes(self, mock_spark_session, large_dataset):
        ...
        mock_spark_session.storage.create_table("silver", "processed_data", schema.fields)
        mock_spark_session.storage.create_table("gold", "aggregated_data", schema.fields)
        ...
        mock_spark_session.storage.insert_data("silver", "processed_data", large_dataset)
