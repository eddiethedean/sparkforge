...
# Set environment to use mock-spark BEFORE any sparkforge imports
import os
...
from mock_spark import StructType, StructField, StringType, IntegerType, DoubleType, TimestampType, BooleanType
...
class DataGenerator:
    ...
    def create_ecommerce_orders(spark, num_orders: int = 100) -> Any:
        ...
        from mock_spark import MockDataFrame
