...
class TestFinancialPipeline:
    ...
    def test_complete_financial_transaction_pipeline_execution(
        ...
        def validate_transactions_transform(spark, df, silvers):
            ...
            return (
                ...
                .withColumn(
                    "day_of_week", F.col("timestamp_parsed").cast("timestamp").dayofweek
                )
                .withColumn(
        ...
        def enrich_accounts_transform(spark, df, silvers):
            ...
            return (
                ...
                .withColumn(
                    "account_age_days",
                    F.current_date().datediff(F.col("opening_date_parsed")),
                )
    ...
    def test_financial_audit_logging(
        ...
        audit_data = mock_spark_session.storage.query_table(
            "audit", "financial_audit_logs"
        )
