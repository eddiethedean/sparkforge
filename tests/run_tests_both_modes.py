...
def main():
    ...
    print(f"Total:       {mock_passed + real_passed:3d} passed, {mock_failed + real_failed:3d} failed")
    ...
    if mock_passed == real_passed and mock_failed == real_failed:
        ...
        print("   This suggests some tests are mock-specific and don't work with real Spark.")
