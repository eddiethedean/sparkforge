...
class TestPipelineExecutionFlow:
    ...
    def test_pipeline_builder_gold_step_creation(self, spark_session):
        ...
        builder.add_gold_transform(
            name="event_summary",
            transform=lambda spark, silvers: list(silvers.values())[0].groupBy("id").count(),
            rules={"id": [F.col("id").isNotNull()]},
    ...
    def test_pipeline_execution_with_mock_data(self, spark_session):
        ...
        # Create mock data
        mock_data = [(1, "click", "2023-01-01"), (2, "view", "2023-01-02"), (3, "purchase", "2023-01-03")]
        mock_df = spark_session.createDataFrame(mock_data, ["id", "event_type", "timestamp"])
    ...
    def test_step_execution_with_real_data(self, spark_session):
        ...
        df = spark_session.createDataFrame(test_data, ["id", "user_id", "event_type", "timestamp"])
