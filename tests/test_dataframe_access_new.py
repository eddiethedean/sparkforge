...
class TestDataFrameAccess:
    ...
    def test_silver_step_creation(self, spark_session, sample_bronze_rules, sample_silver_rules):
    ...
    def test_gold_step_creation(self, spark_session, sample_bronze_rules, sample_silver_rules, sample_gold_rules):
    ...
    def test_pipeline_builder_validation(self, spark_session, sample_bronze_rules, sample_silver_rules, sample_gold_rules):
    ...
    def test_pipeline_creation(self, spark_session, sample_bronze_rules, sample_silver_rules, sample_gold_rules):
    ...
    def test_dataframe_operations(self, spark_session, sample_bronze_data):
        ...
        df_with_date = sample_bronze_data.withColumn("event_date", F.to_date("timestamp"))
    ...
    def test_step_type_detection(self, spark_session, sample_bronze_rules, sample_silver_rules, sample_gold_rules):
        ...
        # Test GoldStep
        def gold_transform(spark, silvers):
            return list(silvers.values())[0] if silvers else spark.createDataFrame([], ["action", "event_date"])
